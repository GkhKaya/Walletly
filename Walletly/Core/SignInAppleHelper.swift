...
final class SignInWithAppleHelper: NSObject {
    ...
    @MainActor
    func startSignInWithAppleFlow(viewController: UIViewController? = nil) async throws -> AppleSignInResultModel {
    ...
    @MainActor
    func startSignInWithAppleFlow(viewController: UIViewController? = nil, completion: @escaping (Result<AppleSignInResultModel, Error>) -> Void) {
...
extension SignInWithAppleHelper: ASAuthorizationControllerDelegate {
    func authorizationController(controller: ASAuthorizationController, didCompleteWithAuthorization authorization: ASAuthorization) {
        do {
            ...
            let result = AppleSignInResultModel(token: token, nonce: nonce)
